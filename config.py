...
# OCR.SPACE API KEY
# ==========================================
OCR_SPACE_API_KEY = "K82387089388957"

# ==========================================
# GEMINI API (Med Chatbot)
# ==========================================
class Config:
    try:
    ...
    CSV_PATH = os.path.join(DATA_DIR, "medical.csv")
    TXT_PATH = os.path.join(DATA_DIR, "medical.txt")
...
EXCEL_COLUMNS = [
    "Date", "Report Type", "Patient Name", "Patient Age", "Patient Gender", "Notes",
    ...
    "Liver Size", "Gall Bladder Status", "Spleen Size", "Pancreas Status",
    "Right Kidney Size", "Left Kidney Size", "Urinary Bladder Status",
    "Ultrasound Findings", "Ultrasound Impression",
]
...
TEST_PARAMETERS = {
    ...
    "Thyroid Test": ["T3 (Triiodothyronine)", "T4 (Thyroxine)", "TSH"],
    "Blood Test": ["Hemoglobin", "RBC", "WBC", "Platelets", "Glucose", "Cholesterol"],
    "Vitals Check": [
